...
class BaseValidator implements MobileNumberValidator
{
    /**
     ...
     * @return App\Console\MobileNumberValidator
     */
    public function make($number, string $countryCode = null): MobileNumberValidator
    {
        try {
